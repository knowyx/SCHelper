...
# константы стиля и пути к файлам
TOPBUTTONSSTYLE = """
            QPushButton {
...
class Ui_about(object):
    ...
    def setupUi(self, about, mainFont):
        ...
        # работа с размерами окна, фоновым цветом и шрифтом
        ...
        # установка шрифтов и вызов функции установки текста на элементы
